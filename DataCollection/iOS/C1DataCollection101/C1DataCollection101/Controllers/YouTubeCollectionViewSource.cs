...
namespace C1DataCollection101
{
    internal class YouTubeCollectionViewSource : C1CollectionViewSource<object>
    {
        ...
        public YouTubeCollectionViewSource(UICollectionView collectionView)
            : base(collectionView)
        {
            CollectionView.RegisterClassForCell(typeof(YouTubeCell), YouTubeCellIdentifier);
            CollectionView.RegisterClassForSupplementaryView(typeof(YouTubeHeaderCell), UICollectionElementKindSection.Header, YouTubeHeaderIdentifier);
        }
