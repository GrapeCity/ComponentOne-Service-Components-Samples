...
declare module wijmo.olap {
    ...
    class Slicer extends wijmo.Control {
         ...
         *
         * The default value for this property is null, which causes the {@link Slicer}
         * to display the {@link field} header at the top of the {@link Slicer}.
         */
        header: string;
        /**
...
declare module wijmo.olap {
     ...
     */
    class PivotFieldCollection extends wijmo.collections.ObservableArray {
        private _ng;
        private _maxItems;
        /**
...
declare module wijmo.olap {
    ...
    class PivotEngine {
         ...
         * with two members, <b>url</b> and <b>cube</b>, that specify
         * how the component should access the service. For example:
         *
         * <pre>
         * var ng = new wijmo.olap.PivotEngine({
         *     itemsSource: {
         ...
         *
         * Our <a href="http://demos.wijmo.com/5/SampleExplorer/SampleExplorer/Sample/OlapServerIntro" target="_blank">OlapServerIntro</a>
        ...
        _getRowKey(row: number): _PivotKey;
...
declare module wijmo.olap {
    ...
    class PivotGrid extends wijmo.grid.FlexGrid {
         ...
         *
         * In most applications, outline mode works best with subtotals shown
         * above the data, so if you set {@link outlineMode} to true is usually
         * makes sense to set {@link totalsBeforeData} to true as well.
         *
         * The default value for this property is <b>false</b>.
         *
         ...
         * property to <b>Subtotals</b> and the {@link totalsBeforeData} property
         * to <b>true</b>.
         *
         * For example:
         *
        ...
        /**
         * Gets an {@link collections.ICollectionView} containing the records
        ...
        _setLength(arr: wijmo.collections.ObservableArray, cnt: number): void;
...
declare module wijmo.olap {
    ...
    class _SqlServerConnection extends _ServerConnection {
        ...
        _createColumnKeys(cellData: Element, columnAxis: Element, cell: any, ordinal: number): number;
        _createColumnOnlyKeys(cellData: Element, columnAxis: Element): void;
        _validateTuple(tuple: Element): any;
    }
}
declare module wijmo.olap {
    /**
