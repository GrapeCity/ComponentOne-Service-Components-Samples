...
declare module wijmo.grid.xlsx {
    ...
    class FlexGridXlsxConverter {
         ...
         *  );</pre>
         */
        static saveAsync(grid: wijmo.grid.FlexGrid, options?: IFlexGridXlsxOptions, fileName?: string, onSaved?: (base64: string) => any, onError?: (reason?: any) => any): wijmo.xlsx.Workbook;
        /**
        ...
        static _getCellStyle(panel: wijmo.grid.GridPanel, fakeCell: HTMLDivElement, r: number, c: number): any;
    ...
    class XlsxFormatItemEventArgs extends wijmo.grid.CellRangeEventArgs {
        ...
        private _xlsxCell;
        private _cellsCache;
        constructor(panel: wijmo.grid.GridPanel, rng: wijmo.grid.CellRange, cell: HTMLDivElement, patternCell: HTMLDivElement, cellsCache: _CellsCache, xlsxCell: wijmo.xlsx.IWorkbookCell);
        /**
