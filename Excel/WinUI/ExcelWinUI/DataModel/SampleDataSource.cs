...
namespace ExcelWinUI.Data
{
    /// <summary>
    /// Base class for <see cref="SampleDataItem"/> that defines common properties.
    /// </summary>
    [Windows.Foundation.Metadata.WebHostHidden]
    public abstract class SampleDataCommon : ExcelWinUI.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        {
            _allItems.Add(new SampleDataItem("Excel",
                   Strings.ExcelWinUITitle,
                   Strings.ExcelWinUIDescription,
                   "",
                   typeof(ExcelWinUI.DemoPage),
                   Strings.ExcelWinUIName));
        }
    }
}
